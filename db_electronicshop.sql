...
--
-- Host: localhost
-- Generation Time: Oct 27, 2022 at 01:35 PM
...
INSERT INTO `product_image` (`id`, `url`, `product_id`, `created_at`, `modified_at`, `deleted_at`) VALUES
(1, 'https://cdn.nguyenkimmall.com/images/detailed/776/10051129-dien-thoai-samsung-galaxy-a03-32gb-den-1.jpg', 1, '2022-10-24 02:23:10', '2022-10-24 02:23:10', NULL),
(2, 'https://cdn.nguyenkimmall.com/images/detailed/776/10051129-dien-thoai-samsung-galaxy-a03-32gb-den-2.jpg', 1, '2022-10-24 02:23:10', '2022-10-24 02:23:10', NULL),
(3, 'https://cdn.nguyenkimmall.com/images/detailed/776/10051129-dien-thoai-samsung-galaxy-a03-32gb-den-3.jpg', 1, '2022-10-24 02:23:10', '2022-10-24 02:23:10', NULL),
(4, 'https://cdn.nguyenkimmall.com/images/detailed/776/10051129-dien-thoai-samsung-galaxy-a03-32gb-den-4.jpg', 1, '2022-10-24 02:23:10', '2022-10-24 02:23:10', NULL);
...
(1, '{\r\n    \"model\": \"A03 (SM-A035F/DS)\",\r\n    \"color\": \"Đen\",\r\n    \"manufacturer\": \"Samsung\",\r\n    \"origin\": \"Trung Quốc\",\r\n    \"warranty_time\": \"12 Tháng\",\r\n    \"memory\": \"32GB\",\r\n    \"monitor\": \"Infinity-V TFT LCD 20:9\",\r\n    \"monitor_size\": \"6.5 \\\"\",\r\n    \"resolution\": \"HD+ (720x1600) pixels\"\r\n}', '2022-10-24 05:54:39', '2022-10-24 14:59:41', NULL);
...
(0, 'Tất cả', NULL, '2022-10-27 12:53:12', '2022-10-27 12:53:42', NULL),
...
ALTER TABLE `product_taggroup`
  ...
  ADD KEY `FK_Product_taggroup_Product_tag_parent_id` (`parent_id`);
...
--
-- Constraints for table `product_taggroup`
--
ALTER TABLE `product_taggroup`
  ADD CONSTRAINT `FK_Product_taggroup_Product_tag_parent_id` FOREIGN KEY (`parent_id`) REFERENCES `product_tag` (`id`),
  ADD CONSTRAINT `FK_Product_taggroup_Product_tag_tag_id` FOREIGN KEY (`tag_id`) REFERENCES `product_tag` (`id`);
